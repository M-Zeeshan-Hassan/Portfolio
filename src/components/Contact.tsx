...
const contactMethods = [
  {
    icon: Mail,
    label: "Email",
    value: "mzhassan980@gmail.com",
    href: "mailto:mzhassan980@gmail.com",
    bg: "bg-[#E74C3C]",
  ...
  },
  {
    icon: Github,
    label: "GitHub",
    value: "M-Zeeshan-Hassan",
    href: "https://github.com/M-Zeeshan-Hassan",
    bg: "bg-black",
    iconColor: "text-white",
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    value: "muhammad-zeeshan-hassan",
    href: "https://www.linkedin.com/in/muhammad-zeeshan-hassan-0b312a316/",
    bg: "bg-blue-800",
    iconColor: "text-white",
  },
];
  ...
  <Card className="glowing-card bg-gray-900/70 border-gray-800 rounded-xl transition-all duration-300 overflow-hidden h-full flex flex-col justify-center">
    ...
    <CardContent>
      <p className="text-gray-300 text-base mb-8">
        I am a Web Developer passionate about building dynamic, user-focused web
        applications.
      </p>
      <div className="space-y-4 mb-8">
        {contactMethods.map((method) => (
          ...
          >
            <span
              className={`w-11 h-11 flex items-center justify-center rounded-full ${method.bg} ${method.iconColor} text-xl transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl`}
            >
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          access_key: "fc81b984-d965-44b8-b36c-c42ff34f54d6",
          name: formData.name,

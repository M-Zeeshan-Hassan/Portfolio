...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { href: "#technologies", label: "Skills", icon: BookOpen },
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
        <div className="flex justify-between items-center h-full">
          ...
          <div className="hidden md:block">
            <Button
              className="px-4 py-2 rounded-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:from-blue-400 hover:via-purple-400 hover:to-pink-400 text-white focus:ring-2 focus:ring-blue-400 hover:shadow-xl transition duration-200 text-sm"
              asChild
            >
              <a href="#contact">
                <span className="relative flex items-center">
